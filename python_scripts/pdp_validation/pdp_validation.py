...
def retrieve_the_whole_structure_of_items_excel(api, category, new_products):
    ...
    writer = pd.ExcelWriter('Regression_PROD_Old_Menu.xlsx', engine='xlsxwriter')
...
new_products = ['Small Blue Coconut Cream Slush', 'Small Strawberry Cream Slush', 'Small Blood Orange Cream Slush', 'Grilled Cheese Burger', 'Classic Cruiser', 'French Toast Sticks Combo']
